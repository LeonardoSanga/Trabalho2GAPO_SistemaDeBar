...
public class VendaDAO {
    ...
    public boolean inserirVenda(VendaDTO vendaDTO, JTable produtos) {
        try {
            ...
            String comando1 = "Insert into Venda (dat_vend, val_vend, tipo_pag_vend) values ( "
                    + "to_date('" + date.format(vendaDTO.getDat_vend()) + "', 'dd/mm/yyyy'), "
                    + vendaDTO.getVal_vend() + ", "
                    + "'" + vendaDTO.getTipo_pag_vend() + "')";
